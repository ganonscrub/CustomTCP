...
class RDT:
	def __init__(self, recv_host, send_host, app_port, show_window):
		self.sender = RDTSender(send_host, app_port, show_window)
		self.receiver = RDTReceiver(recv_host, app_port, show_window)


rdt = RDT(sys.argv[1], (sys.argv[2]), int(sys.argv[3]), show_window)
